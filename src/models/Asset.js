...
const assetSchema = new mongoose.Schema(
  {
    ...
    uniqueAssetId: { type: String, required: true, index: true },
    purchaseDate: { type: Date, default: null },
    vendor: { type: String, trim: true, default: "" },
    invoiceNumber: { type: String, trim: true, default: "", index: true },
    cost: { type: Number, default: 0 },
    warrantyStartDate: { type: Date, default: null },
    warrantyExpiryDate: { type: Date, default: null, index: true },
    warrantyProvider: { type: String, trim: true, default: "" },
    ...
    assignedGroup: { type: String, trim: true, enum: ["Admin department", "All Employees", "Hike team", ""], default: "", index: true },
